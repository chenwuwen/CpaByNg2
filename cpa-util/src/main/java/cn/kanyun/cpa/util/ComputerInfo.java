...
public class ComputerInfo {
    ...
    public static void main(String[] args) {
        Logger LOG = LoggerFactory.getLogger(ComputerInfo.class);
        LOG.info("Initializing System...");
//        需要注意的是,该SystemInfo是oshi包下的类
